	...
	<div class="card-body col-md-4 offset-md-4">
		<form class="form" method="POST" action="{{ route('users.store') }}">
			...
			<div class="form-group">
				...
				<input type="text" name="name" class="form-control" placeholder="Nombre y apellido" value="{{ old('name') }}">
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<input type="text" oninput="checkRut(this)" maxlength="12" name="rut" class="form-control" value="{{ old('rut') }}" >
			</div>
			<div class="form-group">
